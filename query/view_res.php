...
$sql = "SELECT * FROM query WHERE que_id = $que_id";
...
if ($result->num_rows > 0) {
    while($row = $result->fetch_assoc()) {
        ...
        echo "<td>" . $row["que_std_name"]. "</td>";
        echo "<td>" . $row["que_std_email"]. "</td>";
        echo "<td>" . $row["que_std_degree"]. "</td>";
        echo "<td>" . $row["que_description"]. "</td>";
        echo "<td>" . $row["que_response"]. "</td>";
        echo "</tr>";
        echo "</table>";
    }
} else {
