      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a href="tt_view/view_tt.php">View DateSheet</a></li>
            <li><a href="view_anno/view.php">View Announcements</a></li>
            <li><a href="view_project/view_project.html">View Project</a></li>
           </ul>
        </li>
      </ul>
    </div>
...
<table id='customers'>
            ...
            <?php
                require_once 'view_anno.php';
                require_once 'database.php';

                $conn = new Database();
                $announcementDao = new AnnouncementDAO($conn->getConnection());
                $announcements = $announcementDao->getAllAnnouncements();
                foreach ($announcements as $announcement) {
                    
                    echo "<tr>";
                    echo "<td>" . $announcement->getId() . "</td>";
                    echo "<td>" . $announcement->getTitle() . "</td>";
                    echo "<td>" . $announcement->getType() . "</td>";
                    echo "<td>" . $announcement->getDate() . "</td>";
                    echo "<td>" . $announcement->getDescription() . "</td>";
                    echo "</tr>";
                }
            ?>
        </table>
